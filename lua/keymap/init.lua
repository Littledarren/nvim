...
local plug_map = {
    -- Format
    ["n|<F3>"] = map_cu("FormatWrite"):with_noremap():with_silent(),
    -- Bufferline
    ...
    ["n|gd"] = map_cr("lua vim.lsp.buf.definition()"):with_noremap()
        :with_silent(),
    ["n|gy"] = map_cr("lua vim.lsp.buf.type_definition()"):with_noremap()
        :with_silent(),
    ...
    ["n|gR"] = map_cr("TroubleToggle lsp_references"):with_noremap()
        :with_silent(),
    ["n|<leader>xd"] = map_cr("TroubleToggle document_diagnostics"):with_noremap()
        :with_silent(),
    ["n|<leader>xw"] = map_cr("TroubleToggle workspace_diagnostics"):with_noremap()
        :with_silent(),
    ["n|<leader>xq"] = map_cr("TroubleToggle qikfix"):with_noremap()
        :with_silent(),
    ...
    -- Plugin lua dev
    ["n|<A-l>"] = map_cmd("<Plug>(Luadev-RunLine)"):with_silent(),
    ["n|<A-r>"] = map_cmd("<Plug>(Luadev-Run)"):with_silent(),
    -- Plugin split-term
